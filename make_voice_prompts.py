...
PROMPTS = [
    ...
    "Native English, neutral American accent. Male, 16-18, teenage. Studio quality. Persona: charismatic trends commentator. Emotion: energetic, confident, slightly playful. Youthful bright timbre with clean sharp articulation; speaks noticeably fast with a lively, driving cadence, punchy natural emphasis and expressive intonation, like a young creator hyping up his audience without losing clarity. Conversational, spontaneous and human-like, realistic imperfections, fluid transitions, magnetic presence. No breath sounds, no inhalations, no mouth noises, no clicks, no lip smacks, no robotic cadence, no monotone, no overacting.",
]
